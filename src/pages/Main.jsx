        ...
        <div className='main' onMouseMove={handleMouseMove}>
          ...
          <div className='time '>
            ...
            <div className="content flex-col gap-2 font-extrabold">
                ...
                <button onClick={()=>navigate('./verifykyc3')} type="button" class="transition ease-in-out delay-150 hover:scale-110  duration-300 ...  text-white bg-red-700 hover:bg-red-800 px-4 py-1 font-bold rounded-lg dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">Explore</button>
